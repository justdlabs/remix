...
export default function Index() {
  return (
    <>
      ...
      />
      <Container>
        <div className="grid *:[div]:relative *:[div]:*:[div]:min-h-32 gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 [&_a]:cursor-pointer [&_a]:inset-0 [&_a]:absolute [&_a]:size-full">
          <div>
